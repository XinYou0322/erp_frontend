      ...
      >
        ...
        >
          ...
          >
            <button
              type="button"
              @click="emit('selectTab', 'inventory')"
            ...
            <button
              type="button"
              @click="emit('selectTab', 'inventoryLogs')"
              class="w-full text-left px-3 py-2 rounded-lg text-[11px] font-bold transition-colors cursor-pointer"
              :class="
                currentTab === 'inventoryLogs'
                  ? 'bg-blue-50 text-[#0070ea]'
                  : 'text-gray-500 hover:bg-white/80 hover:text-gray-800'
              "
            >
...
const inventoryMenuOpen =
  ref(
    props.currentTab === 'inventory'
    ||
    props.currentTab === 'inventoryLogs'
  )
